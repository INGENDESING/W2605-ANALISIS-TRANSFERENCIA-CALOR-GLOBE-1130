...
7. Cuando se generen informes, presentaciones, calculos y documentos entregables verifica que sean logicos, coherentes, secuenciales, tanto en su contenido como en su estructura. En estos informes nunca usar viñetas, rempalzarlas por tablas estilos elsevier. La redaccion de estos informes debe ser al estilo de science direct /elsevier. Siemre revizar la ortografia y gramatica.
8. Finalmente, agrega una sección de revisión al archivo todo.md con un resumen de los cambios que realizaste y cualquier otra información relevante.
