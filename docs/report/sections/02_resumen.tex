...
El análisis de resistencias térmicas demuestra que la \textbf{convección natural de la glucosa concentra el 98.0\% de la resistencia total} del sistema. La validación mediante \textbf{CFD (COMSOL Multiphysics)} confirmó un coeficiente $U$ de 40.2 W/m$^2\cdot$°C en estado estable, validando la precisión del modelo analítico con una desviación del 11\%. La Figura~\ref{fig:resumen_cfd} ilustra el enfriamiento del agua en la espiral y la alta inercia térmica del producto.
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{@{}lX@{}}
		...
		\midrule
		\textbf{Gestión de Integridad} & Se proyecta una vida útil remanente de \textbf{16.3 años} para el cuerpo cilíndrico. Sin embargo, el \textbf{nuevo fondo toriesférico} presenta una vida útil proyectada de \textbf{7.5 años} bajo el criterio del 10\% de margen de diseño, condicionada por el fenómeno de \textbf{corrosión-fatiga} (0.12 mm/año) inducido por la operación a 75°C y alta ciclicidad. \\
		\midrule
