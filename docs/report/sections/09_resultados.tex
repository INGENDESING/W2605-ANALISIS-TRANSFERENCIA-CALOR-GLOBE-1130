...
\begin{table}[H]
    \centering
    \caption{Área de transferencia requerida para calentamiento continuo de glucosa Globe~1130 de 25\,°C a 57\,°C ($T_w = 75$\,°C, $v = 2.5$\,m/s, $U_{ef} = 30.54$\,W/m\textsuperscript{2}$\cdot$°C).}
    \label{tab:areas_25_57}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}Ncccccc@{}}
        \toprule
        \multicolumn{1}{c}{\textbf{Item}} & $\dot{m}$ [ton/h] & $\dot{m}$ [kg/s] & $\dot{Q}$ [kW] & $\Delta T_{lm}$ [°C] & $A_{req}$ [m\textsuperscript{2}] & $L_{eq}$ [m] \\
        \midrule
        &  1 & 0.278 &  18.8 & 31.2 &  19.7 &  165 \\
        &  4 & 1.111 &  75.2 & 30.7 &  80.2 &  671 \\
        &  8 & 2.222 & 150.3 & 30.1 & 163.7 & 1369 \\
        & 12 & 3.333 & 225.5 & 29.4 & 250.9 & 2099 \\
        & 16 & 4.444 & 300.7 & 28.8 & 341.9 & 2860 \\
        \bottomrule
    \end{tabularx}
\end{table}
...
Para el calentamiento de mantenimiento desde 55\,°C hasta 57\,°C, la menor variación de viscosidad de la glucosa en ese intervalo resulta en un coeficiente efectivo más elevado, $U_{ef} = 36.13$\,W/m\textsuperscript{2}$\cdot$°C, con variación relativa de apenas el 0.6\,\% (criterio $\Delta U/U < 10$\,\% de Incropera et al.\ satisfecho). La LMTD se reduce a 19.0\,°C por la menor diferencia de temperatura entre el agua y la glucosa. La Tabla~\ref{tab:areas_55_57} resume los resultados.

\begin{table}[H]
    \centering
    \caption{Área de transferencia requerida para calentamiento de mantenimiento de glucosa Globe~1130 de 55\,°C a 57\,°C ($T_w = 75$\,°C, $v = 2.5$\,m/s, $U_{ef} = 36.13$\,W/m\textsuperscript{2}$\cdot$°C).}
    \label{tab:areas_55_57}
    \setcounter{itemcount}{0}
    \begin{tabularx}{\textwidth}{@{}Ncccccc@{}}
        \toprule
        \multicolumn{1}{c}{\textbf{Item}} & $\dot{m}$ [ton/h] & $\dot{m}$ [kg/s] & $\dot{Q}$ [kW] & $\Delta T_{lm}$ [°C] & $A_{req}$ [m\textsuperscript{2}] & Cumple ($A_{prop}=13$\,m\textsuperscript{2}) \\
        \midrule
        &  1 & 0.278 &  1.18 & 18.97 &  1.73 & Sí \\
        &  4 & 1.111 &  4.73 & 18.95 &  6.91 & Sí \\
        &  8 & 2.222 &  9.47 & 18.91 & 13.85 & No (límite) \\
        & 12 & 3.333 & 14.20 & 18.87 & 20.82 & No \\
        & 16 & 4.444 & 18.93 & 18.84 & 27.82 & No \\
        \bottomrule
    \end{tabularx}
\end{table}

La Figura~\ref{fig:comp_escenarios_areas} compara visualmente los perfiles de área requerida para ambos rangos de temperatura, destacando la severa penalización de la fuerza impulsora térmica que impone el rango 55–57\,°C: una reducción del 39.4\,\% en la LMTD respecto al rango 25–57\,°C incrementa el área requerida por unidad de potencia transferida en un factor de 1.39.
