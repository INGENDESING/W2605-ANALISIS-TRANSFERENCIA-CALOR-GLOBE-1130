...
El Escenario~4 evalúa la capacidad operativa real del sistema de calentamiento con el área de transferencia de calor del fondo instalado (13~m\textsuperscript{2}, media caña), determinando cuántas descargas de carrotanque de 24~toneladas se pueden completar por día bajo diferentes condiciones de temperatura de entrada.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{../../results/figures/escenario4_comparativa_capacidad.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{../../results/figures/escenario4_ciclo_T.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{../../results/figures/escenario4_gantt.png}
	\caption{Diagrama de Gantt del Escenario~5: 25.5~h de recalentamiento inicial (azul) seguidas de 8 descargas consecutivas de 1.5~h (naranja). Tiempo total: 37.5~h.}
	\label{fig:esc5_gantt}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{../../results/figures/ciclo_T_vs_tiempo_esc2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{../../results/figures/ciclo_T_vs_tiempo_esc3.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{../../results/figures/ciclo_gantt.png}
...
La Figura~\ref{fig:comp_escenarios_areas} compara visualmente los perfiles de área requerida para ambos rangos de temperatura. Con el área del fondo de reemplazo (13\,m\textsuperscript{2}), los flujos máximos alcanzables son:
\begin{itemize}
...
\begin{table}[H]
    \centering
    \caption{Tiempos de calentamiento batch para la chaqueta actual (dimple, 28\,m\textsuperscript{2}) y la del fondo de reemplazo (media caña, 13\,m\textsuperscript{2}). Tanque al 80\,\% de capacidad, $T_w = 75$\,°C, $v = 2.5$\,m/s.}
...
\begin{table}[H]
    \centering
    \caption{Temperatura de salida de la glucosa $T_{out}$ alcanzable en modo continuo con la chaqueta actual (dimple, 28\,m\textsuperscript{2}) y la del fondo de reemplazo (media caña, 13\,m\textsuperscript{2}), para temperaturas de entrada de 25\,°C y 55\,°C ($T_w = 75$\,°C, $v = 2.5$\,m/s).}
...
\begin{figure}[H]
    ...
    \caption{Flujo máximo continuo alcanzable para cumplir la especificación de 57\,°C a la salida, para la chaqueta actual (dimple, 28\,m\textsuperscript{2}) y la del fondo de reemplazo (media caña, 13\,m\textsuperscript{2}), discriminado por temperatura de entrada.}
...
El espesor requerido (9.16~mm) excede marginalmente el existente (9.0~mm) en 0.16~mm. El an\'alisis FEA complementario establece que la condici\'on operativa segura corresponde al 80\% de llenado, donde el factor de seguridad en el nudillo es $FS \geq 1.3$. Al 100\% de llenado, el FS cae a 0.71, confirmando el sobreesfuerzo local. La Tabla~\ref{tab:espesores_fondo} resume ambas condiciones.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{../../results/figures/ciclo_vida_corrosion.png}
	\caption{Proyecci\'on de degradaci\'on del fondo toriesf\'erico bajo dos escenarios de corrosi\'on. La tasa hist\'orica de 0.0625~mm/a\~no (P2543) proyecta una vida \'util remanente de 14.4~a\~nos hasta el l\'imite de dise\~no del 10\%. Bajo las condiciones operativas de 75\,°C y 2\,920~ciclos/a\~no, el mecanismo de corrosi\'on-fatiga eleva la tasa a 0.12~mm/a\~no, reduciendo la vida remanente a 7.5~a\~nos.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.72\textwidth]{../../results/figures/fea0.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{../../results/figures/fea2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{../../results/figures/fea4.png}
