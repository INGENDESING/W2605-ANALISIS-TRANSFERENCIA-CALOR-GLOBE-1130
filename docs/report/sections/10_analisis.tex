...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{@{}p{3.0cm}>{\centering\arraybackslash}p{1.5cm}>{\centering\arraybackslash}p{1.9cm}>{\centering\arraybackslash}p{2.6cm}>{\centering\arraybackslash}p{2.2cm}X@{}}
		...
		Componente cr\'itico restrictivo. El an\'alisis FEA establece que el l\'imite operativo seguro es el 80\% de llenado ($FS \geq 1.3$), mientras que al 100\% el factor de seguridad cae a 0.71 (sobreesfuerzo local en el nudillo). \\
		\midrule
