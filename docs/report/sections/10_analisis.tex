...
El análisis cuantitativo de las dos configuraciones de chaqueta —dimple actual (28\,m\textsuperscript{2}) y media caña propuesta (13\,m\textsuperscript{2})— permite extraer conclusiones de alto valor ingenieril para la toma de decisiones sobre el diseño del sistema de calentamiento del tanque Globe~1130.
