...
│       │   └── 13_anexos.tex
│       │
│       ├── W2605-PR-INF-001 R0.tex   # Documento maestro
│       └── W2605-PR-INF-001 R0.pdf   # PDF generado
│
...
- **Documento maestro**: `W2605-PR-INF-001 R0.tex`
...
2. **Compilar LaTeX** → `docs/report/W2605-PR-INF-001 R0.tex`
