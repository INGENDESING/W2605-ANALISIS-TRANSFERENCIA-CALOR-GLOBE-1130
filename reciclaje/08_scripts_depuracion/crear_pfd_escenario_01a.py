#!/usr/bin/env python3
"""
Generador de PFD para Escenario 01A - Proyecto W2605
...
<svg width="1400" height="1000" viewBox="0 0 1400 1000" xmlns="http://www.w3.org/2000/svg">
    <title>PFD Escenario 01A - Proyecto W2605</title>
    ...
    <!-- Corrientes 2A/2B - Agua entrada -->
    <g>
        <rect x="30" y="640" width="260" height="78" fill="#FFEBEE" stroke="#C62828" stroke-width="2" rx="6"/>
        <text x="160" y="662" font-family="Arial" font-size="12" font-weight="bold" fill="#B71C1C" text-anchor="middle">
            CORRIENTES 2A/2B - Agua Entrada
        </text>
        <text x="160" y="680" font-family="Arial" font-size="10" fill="#212121" text-anchor="middle">
            Entrada centro (45 %) + entrada periferia (55 %)
        </text>
        <text x="160" y="696" font-family="Arial" font-size="11" fill="#212121" text-anchor="middle">
            30,900 kg/h | 65.0°C | 8,224 MJ/h
        </text>
        <text x="160" y="712" font-family="Arial" font-size="9" fill="#616161" text-anchor="middle">
            30.9 m³/h | Cp = 4.18 kJ/kg·K
        </text>
    </g>
    
    <!-- Corriente 3 - Agua salida (mezcla) -->
    <g>
        <rect x="620" y="640" width="260" height="78" fill="#FFEBEE" stroke="#C62828" stroke-width="2" rx="6"/>
        <text x="750" y="662" font-family="Arial" font-size="12" font-weight="bold" fill="#B71C1C" text-anchor="middle">
            CORRIENTE 3 - Agua Salida (mezcla)
        </text>
        <text x="750" y="680" font-family="Arial" font-size="10" fill="#212121" text-anchor="middle">
            Salida común al 45 % del área de transferencia
        </text>
        <text x="750" y="696" font-family="Arial" font-size="11" fill="#212121" text-anchor="middle">
            30,900 kg/h | 64.9°C | 8,218 MJ/h
        </text>
        <text x="750" y="712" font-family="Arial" font-size="9" fill="#616161" text-anchor="middle">
