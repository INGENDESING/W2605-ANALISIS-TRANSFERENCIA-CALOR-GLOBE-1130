...
# -*- coding: utf-8 -*-
"""
Generador de PFD Limpio - Proyecto W2605
...
def crear_titulo():
    ...
    <g id="titulo">
        ...
        <text x="600" y="42" font-family="Arial, sans-serif" font-size="18" font-weight="bold" fill="{C['blanco']}" text-anchor="middle">PFD W2605 - Sistema de Almacenamiento y Carga de Glucosa</text>
...
<svg width="{WIDTH}" height="{HEIGHT}" viewBox="0 0 {WIDTH} {HEIGHT}" xmlns="http://www.w3.org/2000/svg">
    <title>PFD W2605 - Balance de Materia y Energia</title>
    ...
    # Guardar
    output_path = os.path.join(os.path.dirname(__file__), '..', 'results', 'PFD_W2605_LIMPIO.svg')
...
if __name__ == '__main__':
    print('=' * 70)
    print('GENERADOR DE PFD LIMPIO - PROYECTO W2605')
    print('=' * 70)
    print()
