...
def main():
    ...
    os.makedirs(FIGURES_DIR, exist_ok=True)
    plt.savefig(os.path.join(FIGURES_DIR, 'escenario4_comparativa_capacidad.png'), bbox_inches='tight')
    plt.savefig(os.path.join(FIGURES_DIR, 'escenario4_comparativa_capacidad.pdf'), bbox_inches='tight')
