"""
Modulo de simulacion del Escenario 5 — Proyecto P2611
======================================================
Ciclo industrial de despacho: 192 toneladas de glucosa
partiendo de 25°C, 8 descargas de 24 toneladas a carrotanque.
...
def simular_ciclo_esc5(dt_s=30.0):
    """
    Simula el ciclo completo del Escenario 5 (arranque frio desde 25°C).
    ...
    print(f"\n{'='*90}")
    print(f"ESCENARIO 5: Ciclo industrial de despacho (arranque frio desde 25°C)")
    print(f"192 ton de glucosa a 25°C, agua a 75°C, 8 descargas de 24 ton a 57°C")
    print(f"{'='*90}")
