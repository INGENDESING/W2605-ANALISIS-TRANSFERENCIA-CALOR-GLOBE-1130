"""
Escenario 01B - Calculo de temperatura de salida de glucosa
...
Q_AGUA_M3H = 30.9          # Caudal de agua [m3/h]
...
V_AGUA_MC = 1.338          # Velocidad en media caña para 30.9 m3/h [m/s]
...
def main():
    ...
    # Exportar a CSV
    csv_path = '../results/escenario_01b_resultados.csv'
