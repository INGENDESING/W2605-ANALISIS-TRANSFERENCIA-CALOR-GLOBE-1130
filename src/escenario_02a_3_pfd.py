"""
Escenario 02A-3 - Calculo de temperatura de salida de glucosa
...
T_GLUCOSA_IN = 54.0        # Temperatura de entrada de glucosa [°C] (igual al 01C)
...
def main():
    ...
    # Exportar a CSV
    csv_path = '../results/escenario_02a_3_resultados.csv'
