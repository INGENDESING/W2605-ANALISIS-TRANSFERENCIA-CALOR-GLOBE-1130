"""
Escenario 02B-1 - Calculo de temperatura de salida de glucosa
...
Parametros del Escenario 02B-1:
...
T_GLUCOSA_IN = 60.0        # Temperatura de entrada de glucosa [°C]
...
def main():
    print("=" * 78)
    print("ESCENARIO 02B-1 - Calculo de temperatura de salida de glucosa")
    ...
    # Exportar a CSV
    csv_path = '../results/escenario_02b_1_resultados.csv'
