"""
Escenario 02B-2 - Calculo de temperatura de salida de glucosa
Agua de servicio a 75°C con velocidad aumentada a 2.5 m/s
...
T_GLUCOSA_IN = 57.0        # Temperatura de entrada de glucosa [°C]
...
V_AGUA_MC = 2.5            # Velocidad en media caña [m/s]
...
def main():
    print("=" * 78)
    print("ESCENARIO 02B-2 - Calculo de temperatura de salida de glucosa")
    print("Agua de servicio a 75°C, velocidad 2.5 m/s")
    ...
    print(f"  - Aislamiento: {ESPESOR_AISLAMIENTO*1000:.1f} mm")
    ...
    # Exportar a CSV
    csv_path = '../results/escenario_02b_2_resultados.csv'
