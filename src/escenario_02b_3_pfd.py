"""
Escenario 02B-3 - Calculo de temperatura de salida de glucosa
...
def main():
    print("=" * 78)
    print("ESCENARIO 02B-3 - Calculo de temperatura de salida de glucosa")
    ...
    # Exportar a CSV
    csv_path = '../results/escenario_02b_3_resultados.csv'
